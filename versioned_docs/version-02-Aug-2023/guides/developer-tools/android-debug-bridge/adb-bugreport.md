...
Bug reports [can also be gathered using the ML Hub](/versioned_docs/version-02-Aug-2023/guides/developer-tools/ml-hub/ml-hub-bugreport.md).
:::
...
Downloading the file is as simple as navigating to the [Device Bridge](/versioned_docs/version-02-Aug-2023/guides/developer-tools/ml-hub/ml-hub-device-bridge), going to the Files tab, and selecting the relevant bug report:
