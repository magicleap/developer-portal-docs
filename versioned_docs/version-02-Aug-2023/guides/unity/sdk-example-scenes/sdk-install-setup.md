...
- [Unity Editor in the range of **2022.2.x**](/versioned_docs/version-02-Aug-2023/guides/unity/getting-started/install-the-tools.md#install-unity-editor)

## Downloading the Examples

This section will walk you through downloading the Magic Leap Examples Unity project using the Package Manager inside [ML Hub](/versioned_docs/version-02-Aug-2023/guides/getting-started/install-the-tools.md).
...
3. Make sure the project is opened using the **Magic Leap 2 compatible editor version** that you installed in [Getting Started](/versioned_docs/version-02-Aug-2023/guides/unity/getting-started/install-the-tools.md#install-unity-editor).
...
:::info
For information on which of these examples work in App Simulator refer to the [App Simulator Key API Features](/versioned_docs/version-02-Aug-2023/guides/developer-tools/app-sim/app-simulator.md) guide.
:::
