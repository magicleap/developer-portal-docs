...
- ### **Device fit quality**
     ...
     Users should complete the Custom Fit application to ensure optimal performance and visual comfort. See [Headset Fit](/versioned_docs/version-02-Aug-2023/guides/features/eye-tracking/headset-fit.md) for more information.
