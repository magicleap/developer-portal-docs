...
|--|--|--|
| [MLResult.Code](/versioned_docs/version-02-Aug-2023/unity-api/api/UnityEngine.XR.MagicLeap/UnityEngine.XR.MagicLeap.MLResult.md#int-code) |resultCode|The code to convert into a string value.|
...
| Type | Name  | Description  | 
|--|--|--|
| [Code](/versioned_docs/version-02-Aug-2023/unity-api/api/UnityEngine.XR.MagicLeap/UnityEngine.XR.MagicLeap.MLResult.md#int-code) |result|The code to use for the created MLResult.|
| string |msg|The message to use for the created MLResult.|
...
| Type | Name  | Description  | 
|--|--|--|
| [Code](/versioned_docs/version-02-Aug-2023/unity-api/api/UnityEngine.XR.MagicLeap/UnityEngine.XR.MagicLeap.MLResult.md#int-code) |resultCode|Identifier of Magic Leap API results. |
| string |functionName||
| Predicate&lt; [Code](/versioned_docs/version-02-Aug-2023/unity-api/api/UnityEngine.XR.MagicLeap/UnityEngine.XR.MagicLeap.MLResult.md#int-code) &gt; |successCase|Identifier of Magic Leap API results. |
| bool |showError||
...
| Type | Name  | Description  | 
|--|--|--|
| [Code](/versioned_docs/version-02-Aug-2023/unity-api/api/UnityEngine.XR.MagicLeap/UnityEngine.XR.MagicLeap.MLResult.md#int-code) |result|The code to determine if it is Ok.|
...
| Type | Name  | Description  | 
|--|--|--|
| [Code](/versioned_docs/version-02-Aug-2023/unity-api/api/UnityEngine.XR.MagicLeap/UnityEngine.XR.MagicLeap.MLResult.md#int-code) |result|The code to determine if it is pending.|
...
### implicit operator Task {#implicit-operator-task}
...
| Type | Name  | Description  | 
|--|--|--|
| [MLResult](/versioned_docs/version-02-Aug-2023/unity-api/api/UnityEngine.XR.MagicLeap/UnityEngine.XR.MagicLeap.MLResult.md) |r|Magic Leap API return value. |
...
| Type | Name  | Description  | 
|--|--|--|
| [MLResult](/versioned_docs/version-02-Aug-2023/unity-api/api/UnityEngine.XR.MagicLeap/UnityEngine.XR.MagicLeap.MLResult.md) |one|The first struct to compare with the second struct. |
| [MLResult.Code](/versioned_docs/version-02-Aug-2023/unity-api/api/UnityEngine.XR.MagicLeap/UnityEngine.XR.MagicLeap.MLResult.md#int-code) |two|The second struct to compare with the first struct. |
...
| Type | Description  | 
|--|--|
| readonly [Code](/versioned_docs/version-02-Aug-2023/unity-api/api/UnityEngine.XR.MagicLeap/UnityEngine.XR.MagicLeap.MLResult.md#int-code) | Identifier of Magic Leap API results.  |
...
| WebRTCSendNativeFrameError | | Native Frame failed to be sent.   |
