...
| Type | Name  | Description  | 
|--|--|--|
| [MLMedia.Player.Track](/versioned_docs/version-02-Aug-2023/unity-api/api/UnityEngine.XR.MagicLeap/MLMedia/Player/Track/UnityEngine.XR.MagicLeap.MLMedia.Player.Track.md) |track|Track from the prepared source that can be selected by the media player. |
