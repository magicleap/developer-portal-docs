...
You can read more about what the Object Occlusion API offers in the MagicLeap documentation: [Occlusion](/versioned_docs/version-31-Aug-2023/api-ref/api/Modules/group___occlusion/group___occlusion.md).
