...
:::note
If you're new to developing apps for the Magic Leap 2 devices, see our [Developer Tools](/versioned_docs/version-31-Aug-2023/guides/developer-tools) guides for more information on getting started.
:::
...
You can find instructions for setting up Magic Leap Remote Rendering and using it with Unreal Engine 5 on the Magic Leap 2 developer portal. See [Remote Rendering service](/versioned_docs/version-31-Aug-2023/guides/remote-rendering/remote-rendering) and [Remote Rendering with Unreal Engine 5](/versioned_docs/version-31-Aug-2023/guides/remote-rendering/remote-render-unreal-engine-5).
...
For step-by-step instructions on creating a simple app with the version of Unreal Engine you just built, see [Create an app using Unreal Engine](/versioned_docs/version-31-Aug-2023/guides/unreal/unreal-create-app).
