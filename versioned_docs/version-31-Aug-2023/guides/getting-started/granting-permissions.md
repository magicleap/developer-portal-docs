...
Dangerous permissions need to be **[requested at runtime](/versioned_docs/version-31-Aug-2023/guides/unity/permissions/requesting-permissions.md#requesting-normal-install-time-permissions)**. When an application requests a permission a prompt will show on the applications screen.
