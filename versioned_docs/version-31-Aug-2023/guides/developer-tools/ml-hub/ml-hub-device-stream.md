...
If perfect image quality is desired, it is recommended to instead do a capture session [using our adb-enabled tools](/versioned_docs/version-31-Aug-2023/guides/developer-tools/android-debug-bridge/android-capture-commands) or by [using the ML Hub Advanced Capture tooling](/versioned_docs/version-31-Aug-2023/guides/developer-tools/ml-hub/ml-hub-advanced-capture).
:::
...
If connecting to the headset fails, ensure [connecting to the Device Bridge works](/versioned_docs/version-31-Aug-2023/guides/developer-tools/ml-hub/ml-hub-device-bridge#wifi-bridge).
