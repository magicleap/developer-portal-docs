...
Here are some commands used in ADB specifically pertaining to the [Capture](/versioned_docs/version-22-Mar-2023/guides/features/capture-overview.md) functionality and downloading on-device screenshots and video/audio recordings.
...
For other general use commands, please reference the [ADB  Commands](/versioned_docs/version-22-Mar-2023/guides/developer-tools/android-debug-bridge/adb-commands.md) page.
