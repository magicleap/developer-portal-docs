...
- Q: Can the map tool be part of a start-up procedure?
  - A: Your application is able to launch the map tool using [Android Intents](/versioned_docs/version-22-Mar-2023/guides/features/android-intents-overview.md).
