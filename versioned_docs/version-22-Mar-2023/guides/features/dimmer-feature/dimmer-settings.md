...
Please refer to the [Segmented Dimmer Design Guidelines](/versioned_docs/version-22-Mar-2023/guides/features/dimmer-feature/dimmer-design-guidelines.md) to learn about optimizing your app for Segmented Dimming.
