...
:::note
Anchors can also be created and submitted to the map from inside your application. See [Spatial Anchors API](/versioned_docs/version-22-Mar-2023/guides/unity/perception/anchors/spatial-anchors-api.md) for more details.
:::
