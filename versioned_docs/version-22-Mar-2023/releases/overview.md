...
Learn what changes were made in the latest OS release. For your device to take advantage of the latest tools and features, make sure you [flash your device](/versioned_docs/version-22-Mar-2023/guides/device/updating-the-os/device-flashing-guide.md) with the latest OS.
