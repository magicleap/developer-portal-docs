...
|                | Name           |
| -------------- | -------------- |
| enum | **[Anonymous Enum 11](/api-ref/api/Modules/group___input/group___input.md#enums-anonymous-enum-11)** <br></br> { <br></br>[MLResultAPIPrefix_Input](/api-ref/api/Files/ml__input_8h.md#enums-mlresultapiprefix-input) = ( 0x21DC  << 16)<br></br>} |
...
| enum | **[Anonymous Enum 12](/api-ref/api/Modules/group___input/group___input.md#enums-anonymous-enum-12)** <br></br> { <br></br>[MLInput_MaxControllers](/api-ref/api/Files/ml__input_8h.md#enums-mlinput-maxcontrollers) = 1,<br></br> [MLInput_MaxControllerTouchpadTouches](/api-ref/api/Files/ml__input_8h.md#enums-mlinput-maxcontrollertouchpadtouches) = 2<br></br>} |
