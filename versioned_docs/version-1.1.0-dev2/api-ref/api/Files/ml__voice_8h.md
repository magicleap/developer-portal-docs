...
|                | Name           |
| -------------- | -------------- |
| enum | **[Anonymous Enum 24](/api-ref/api/Modules/group___input/group___input.md#enums-anonymous-enum-24)** <br></br> { <br></br>[MLResultAPIPrefix_Voice](/api-ref/api/Files/ml__voice_8h.md#enums-mlresultapiprefix-voice) = ( 0xbe7a  << 16)<br></br>} |
