...
| void | **[MLCameraIntrinsicCalibrationParametersInit](/api-ref/api/Modules/group___camera/group___camera.md#void-mlcameraintrinsiccalibrationparametersinit)**([MLCameraIntrinsicCalibrationParameters](/api-ref/api/Modules/group___camera/struct_m_l_camera_intrinsic_calibration_parameters.md) * inout_data)<br></br>Initializes the default values for [MLCameraIntrinsicCalibrationParameters](/api-ref/api/Modules/group___camera/struct_m_l_camera_intrinsic_calibration_parameters.md).  |
...
Initializes the default values for [MLCameraIntrinsicCalibrationParameters](/api-ref/api/Modules/group___camera/struct_m_l_camera_intrinsic_calibration_parameters.md). 
