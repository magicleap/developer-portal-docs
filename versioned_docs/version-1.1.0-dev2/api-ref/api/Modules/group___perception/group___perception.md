...
|                | Name           |
| -------------- | -------------- |
| enum | **[Anonymous Enum 22](/api-ref/api/Modules/group___perception/group___perception.md#enums-anonymous-enum-22)** <br></br> { <br></br>[MLResultAPIPrefix_Snapshot](/api-ref/api/Modules/group___perception/group___perception.md#enums-mlresultapiprefix-snapshot) = ( 0x87b8  << 16)<br></br>} |
