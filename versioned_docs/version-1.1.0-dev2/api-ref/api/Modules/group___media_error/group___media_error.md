...
|                | Name           |
| -------------- | -------------- |
| enum | **[Anonymous Enum 17](/api-ref/api/Modules/group___media_error/group___media_error.md#enums-anonymous-enum-17)** <br></br> { <br></br>[MLResultAPIPrefix_MediaGeneric](/api-ref/api/Modules/group___media_error/group___media_error.md#enums-mlresultapiprefix-mediageneric) = ( 0xbf3b  << 16)<br></br>} |
...
| enum | **[Anonymous Enum 18](/api-ref/api/Modules/group___media_error/group___media_error.md#enums-anonymous-enum-18)** <br></br> { <br></br>[MLResultAPIPrefix_Media](/api-ref/api/Modules/group___media_error/group___media_error.md#enums-mlresultapiprefix-media) = ( 0x4184  << 16)<br></br>} |
...
| enum | **[Anonymous Enum 19](/api-ref/api/Modules/group___media_error/group___media_error.md#enums-anonymous-enum-19)** <br></br> { <br></br>[MLResultAPIPrefix_MediaDRM](/api-ref/api/Modules/group___media_error/group___media_error.md#enums-mlresultapiprefix-mediadrm) = ( 0x62ce  << 16)<br></br>} |
...
| enum | **[Anonymous Enum 20](/api-ref/api/Modules/group___media_error/group___media_error.md#enums-anonymous-enum-20)** <br></br> { <br></br>[MLResultAPIPrefix_MediaOMX](/api-ref/api/Modules/group___media_error/group___media_error.md#enums-mlresultapiprefix-mediaomx) = ( 0x5f76  << 16),<br></br> [MLResultAPIPrefix_MediaOMXExtensions](/api-ref/api/Modules/group___media_error/group___media_error.md#enums-mlresultapiprefix-mediaomxextensions) = ( 0x11d9  << 16),<br></br> [MLResultAPIPrefix_MediaOMXVendors](/api-ref/api/Modules/group___media_error/group___media_error.md#enums-mlresultapiprefix-mediaomxvendors) = ( 0xe4d0  << 16)<br></br>} |
| enum | **[Anonymous Enum 21](/api-ref/api/Modules/group___media_error/group___media_error.md#enums-anonymous-enum-21)** <br></br> { <br></br>[MLResultAPIPrefix_MediaPlayer](/api-ref/api/Modules/group___media_error/group___media_error.md#enums-mlresultapiprefix-mediaplayer) = ( 0xc435  << 16)<br></br>} |
