...
|Custom| Application can define a custom tracker profiler. See [MLMarkerTrackerCustomProfile](/versioned_docs/version-1.1.0-dev2/api-ref/api/Modules/group___marker_tracking/struct_m_l_marker_tracker_custom_profile.md) for more details.|
...
- [Unity Marker Tracking Overview](/versioned_docs/version-1.1.0-dev2/guides/unity/marker-tracking/marker-tracker-overview.md)
  - Learn how to implement Marker Tracking inside your Unity Application.
- [C++ Marker Tracking API](/versioned_docs/version-1.1.0-dev2/api-ref/api/Modules/group___marker_tracking/group___marker_tracking.md)
