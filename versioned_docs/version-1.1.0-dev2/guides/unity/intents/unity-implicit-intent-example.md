...
:::tip
See the [Intents Feature Overview](/versioned_docs/version-1.1.0-dev2/guides/features/android-intents-overview.md) for a list of possible system-level intents.
:::
