...
1. Follow the steps given in the [Examples Project Install Guide](/versioned_docs/version-1.1.0-dev2/guides/unity/sdk-example-scenes/sdk-install-setup.md) to setup the Unity project.
