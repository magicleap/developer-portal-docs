...
You must enable the `CAMERA` and `RECORD_AUDIO` permissions in the Unity Project Settings. Refer to the [Permissions Guide](/versioned_docs/version-1.1.0-dev2/guides/unity/permissions/declaring-permissions.md) for more information.
...
- To get more information on what errors are occurring on device, you can use the logs from the [device bridge](/versioned_docs/version-1.1.0-dev2/guides/developer-tools/ml-hub/ml-hub-device-bridge.md)
