...
- ### **Device fit quality**
     ...
     Users should complete the Custom Fit application to ensure optimal performance and visual comfort. See [Headset Fit](/versioned_docs/version-1.1.0-dev2/guides/features/eye-tracking/headset-fit.md) for more information.
