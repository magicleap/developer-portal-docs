...
- [System Voice Intents](/versioned_docs/version-1.1.0-dev2/guides/features/android-intents-overview#system-voice-intents)
- [Unity Voice Input](/versioned_docs/version-1.1.0-dev2/guides/unity/input/voice-intents/voice-intents-overview.md)
- [CAPI Voice Input](/versioned_docs/version-1.1.0-dev2/api-ref/api/Modules/group___input/struct_m_l_voice_intent_settings.md)
...
*“All the information they provide is relevant to the task; therefore omit any irrelevant information”*
...
*“Make your contribution one that is true to the core functions of your app.”*
