...
If you installed Lab 2.0 in the past, you'll need to uninstall it and then install the Magic Leap Hub by following the instructions here: [Uninstall the Lab 2.0](/versioned_docs/version-1.1.0-dev2/guides/developer-tools/ml-hub/uninstall-lab-2-0.md)
...
After installing the ML Hub, you are ready to set up your [preferred development environment](/versioned_docs/version-1.1.0-dev2/guides/getting-started/developer-environment.md).
