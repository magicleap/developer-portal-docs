...
public MLResult.Code MLGazeRecognitionGetState(
    ulong handle,
    out MLGazeRecognitionState state
)
```
...
| out [MLGazeRecognitionState](/unity-api/api/UnityEngine.XR.MagicLeap/MLGazeRecognition/NativeBindings/UnityEngine.XR.MagicLeap.MLGazeRecognition.NativeBindings.MLGazeRecognitionState.md) |state|Information about the gaze.|
...
public MLResult.Code MLGazeRecognitionGetStaticData(
    ulong handle,
    out MLGazeRecognitionStaticData data
)
```
...
|--|--|--|
| ulong |handle|A handle to Gaze Recognition created by MLGazeRecognitionCreate().|
| out [MLGazeRecognitionStaticData](/unity-api/api/UnityEngine.XR.MagicLeap/MLGazeRecognition/NativeBindings/UnityEngine.XR.MagicLeap.MLGazeRecognition.NativeBindings.MLGazeRecognitionStaticData.md) |data|Target to populate the data about Gaze Recognition..|
