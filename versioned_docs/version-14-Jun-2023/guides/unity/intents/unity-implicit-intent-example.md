...
:::tip
See the [Intents Feature Overview](/versioned_docs/version-14-Jun-2023/guides/features/android-intents-overview.md) for a list of possible system-level intents.
:::
