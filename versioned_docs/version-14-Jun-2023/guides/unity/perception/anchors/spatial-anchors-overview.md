...
:::note
Spatial Anchors can be created from inside your application. See [Spatial Anchors API](/versioned_docs/version-14-Jun-2023/guides/unity/perception/anchors/spatial-anchors-api.md) for more details.
:::
