...
- Native SDK Version `1.0.0` (Only needed when building when using [Magic Leap Native API](/versioned_docs/version-22-May-2023/api-ref/api/indexpage.md), like the Magic Leap samples)
- OpenXR SDK Version `1.0.27` or higher
- Completed [Magic Leap Native SDK instructions.](/versioned_docs/version-22-May-2023/guides/native/getting-started/native-getting-started)
...
To build the Magic Leap OpenXR samples please follow the normal [Magic Leap Native SDK instructions.](/versioned_docs/version-22-May-2023/guides/native/getting-started/native-getting-started).
