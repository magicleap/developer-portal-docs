...
Follow our guides on [installing the Magic Leap Hub](/versioned_docs/version-22-May-2023/guides/getting-started/install-the-tools.md#install-magic-leap-hub).
