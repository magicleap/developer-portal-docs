...
Dangerous or Runtime permissions can be enabled via the UI graphic that shows at runtime, the system menu **Settings **> Privacy**, or using [adb](/docs/guides//developer-tools/android-debug-bridge/adb-setup.md)](/docs/guides//developer-tools/android-debug-bridge/adb-setup.md).
