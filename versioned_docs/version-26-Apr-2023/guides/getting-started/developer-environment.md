...
[Get started developing for Magic Leap 2 using Unity](/docs/guides/unity/getting-started/unity-getting-started.md).

[![](/img/unity-development-magic-leap.png)](/docs/guides/unity/getting-started/unity-getting-started.md)
...
[Get started developing for Magic Leap 2 using the native C API](/docs/guides/native/getting-started/native-setup-overview.md).

[![](/img/c-api-development-magic-leap.png)](/docs/guides/native/getting-started/native-setup-overview.md)
