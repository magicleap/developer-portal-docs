...
1. Follow the [Unity Getting Started Guide](/versioned_docs/version-22-Feb-2023/guides/unity/getting-started/unity-getting-started.md) to ensure your development environment is set up properly.
