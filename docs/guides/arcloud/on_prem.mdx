...
description: "Demo server or developer's laptop."
---
...
Follow the official instructions for enabling Kubernetes on Docker Desktop: https://docs.docker.com/desktop/kubernetes/
