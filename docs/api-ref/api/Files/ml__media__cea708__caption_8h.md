...
|                | Name           |
| -------------- | -------------- |
| enum | **[Anonymous Enum 17](/api-ref/api/Modules/group___media_player/group___media_player.md#enums-anonymous-enum-17)** <br></br> { <br></br>[MLCea708CaptionWindows_Max](/api-ref/api/Files/ml__media__cea708__caption_8h.md#enums-mlcea708captionwindows-max) = 8<br></br>}<br></br>Cea708 Caption maximum windows constant.  |
