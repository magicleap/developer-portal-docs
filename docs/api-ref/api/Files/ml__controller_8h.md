...
|                | Name           |
| -------------- | -------------- |
| enum | **[MLControllerMode](/api-ref/api/Modules/group___controller/group___controller.md#enums-mlcontrollermode)** <br></br> { <br></br>[Deprecated_Mode_0](/api-ref/api/Files/ml__controller_8h.md#enums-deprecated-mode-0) = 0,<br></br> [Deprecated_Mode_1](/api-ref/api/Files/ml__controller_8h.md#enums-deprecated-mode-1) = 1,<br></br> [MLControllerMode_Fused6Dof](/api-ref/api/Files/ml__controller_8h.md#enums-mlcontrollermode-fused6dof) = 2,<br></br> [MLControllerMode_Count](/api-ref/api/Files/ml__controller_8h.md#enums-mlcontrollermode-count),<br></br> [MLControllerMode_Ensure32Bits](/api-ref/api/Files/ml__controller_8h.md#enums-mlcontrollermode-ensure32bits) = 0x7FFFFFFF<br></br>}<br></br>A set of possible tracking modes for the Controller system.  |
| enum | **[Anonymous Enum 7](/api-ref/api/Modules/group___controller/group___controller.md#enums-anonymous-enum-7)** <br></br> { <br></br>[MLController_MaxActive](/api-ref/api/Files/ml__controller_8h.md#enums-mlcontroller-maxactive) = 1<br></br>} |
| enum | **[MLControllerCalibAccuracy](/api-ref/api/Modules/group___controller/group___controller.md#enums-mlcontrollercalibaccuracy)** <br></br> { <br></br>[MLControllerCalibAccuracy_Bad](/api-ref/api/Files/ml__controller_8h.md#enums-mlcontrollercalibaccuracy-bad) = 0,<br></br> [MLControllerCalibAccuracy_Low](/api-ref/api/Files/ml__controller_8h.md#enums-mlcontrollercalibaccuracy-low) = 1,<br></br> [MLControllerCalibAccuracy_Medium](/api-ref/api/Files/ml__controller_8h.md#enums-mlcontrollercalibaccuracy-medium) = 2,<br></br> [MLControllerCalibAccuracy_High](/api-ref/api/Files/ml__controller_8h.md#enums-mlcontrollercalibaccuracy-high) = 3,<br></br> [MLControllerCalibAccuracy_Ensure32Bits](/api-ref/api/Files/ml__controller_8h.md#enums-mlcontrollercalibaccuracy-ensure32bits) = 0x7FFFFFFF<br></br>}<br></br>Calibration Accuracy levels for controller.  |
| enum | **[MLControllerStatus](/api-ref/api/Modules/group___controller/group___controller.md#enums-mlcontrollerstatus)** <br></br> { <br></br>[MLControllerStatus_NotActive](/api-ref/api/Files/ml__controller_8h.md#enums-mlcontrollerstatus-notactive) = 0,<br></br> [MLControllerStatus_Active_Rotation_Only](/api-ref/api/Files/ml__controller_8h.md#enums-mlcontrollerstatus-active-rotation-only) = 1,<br></br> [MLControllerStatus_Active](/api-ref/api/Files/ml__controller_8h.md#enums-mlcontrollerstatus-active) = 2,<br></br> [MLControllerStatus_Ensure32Bits](/api-ref/api/Files/ml__controller_8h.md#enums-mlcontrollerstatus-ensure32bits) = 0x7FFFFFFF<br></br>}<br></br>Stream mode for controller stream.  |
