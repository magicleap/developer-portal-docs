...
|                | Name           |
| -------------- | -------------- |
| enum | **[MLPlanesQueryFlags](/api-ref/api/Modules/group___planes/group___planes.md#enums-mlplanesqueryflags)** <br></br> { <br></br>[MLPlanesQueryFlag_Vertical](/api-ref/api/Files/ml__planes_8h.md#enums-mlplanesqueryflag-vertical) = 1 << 0,<br></br> [MLPlanesQueryFlag_Horizontal](/api-ref/api/Files/ml__planes_8h.md#enums-mlplanesqueryflag-horizontal) = 1 << 1,<br></br> [MLPlanesQueryFlag_Arbitrary](/api-ref/api/Files/ml__planes_8h.md#enums-mlplanesqueryflag-arbitrary) = 1 << 2,<br></br> [MLPlanesQueryFlag_AllOrientations](/api-ref/api/Files/ml__planes_8h.md#enums-mlplanesqueryflag-allorientations) = MLPlanesQueryFlag_Vertical |
                                       MLPlanesQueryFlag_Horizontal |
                                       MLPlanesQueryFlag_Arbitrary,<br></br> [MLPlanesQueryFlag_OrientToGravity](/api-ref/api/Files/ml__planes_8h.md#enums-mlplanesqueryflag-orienttogravity) = 1 << 3,<br></br> [MLPlanesQueryFlag_Inner](/api-ref/api/Files/ml__planes_8h.md#enums-mlplanesqueryflag-inner) = 1 << 4,<br></br> [MLPlanesQueryFlag_Semantic_Ceiling](/api-ref/api/Files/ml__planes_8h.md#enums-mlplanesqueryflag-semantic-ceiling) = 1 << 6,<br></br> [MLPlanesQueryFlag_Semantic_Floor](/api-ref/api/Files/ml__planes_8h.md#enums-mlplanesqueryflag-semantic-floor) = 1 << 7,<br></br> [MLPlanesQueryFlag_Semantic_Wall](/api-ref/api/Files/ml__planes_8h.md#enums-mlplanesqueryflag-semantic-wall) = 1 << 8,<br></br> [MLPlanesQueryFlag_Semantic_All](/api-ref/api/Files/ml__planes_8h.md#enums-mlplanesqueryflag-semantic-all) = MLPlanesQueryFlag_Semantic_Ceiling |
                                       MLPlanesQueryFlag_Semantic_Floor |
                                       MLPlanesQueryFlag_Semantic_Wall,<br></br> [MLPlanesQueryFlag_Polygons](/api-ref/api/Files/ml__planes_8h.md#enums-mlplanesqueryflag-polygons) = 1 << 9,<br></br> [MLPlanesQueryFlags_Ensure32Bits](/api-ref/api/Files/ml__planes_8h.md#enums-mlplanesqueryflags-ensure32bits) = 0x7FFFFFFF<br></br>} |
